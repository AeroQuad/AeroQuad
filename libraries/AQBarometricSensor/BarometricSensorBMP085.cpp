...
BarometricSensorBMP085::BarometricSensorBMP085()
{
...
//    pressureFactor = 1/5.255;
  pressureTime = 0;
  previousPressureTime = 0;
}
  
void BarometricSensorBMP085::requestRawPressure(void) 
{
  updateRegisterI2C(altitudeAddress, 0xF4, 0x34+(overSamplingSetting<<6));
}
  
long BarometricSensorBMP085::readRawPressure(void) 
{
...
void BarometricSensorBMP085::requestRawTemperature(void) 
{
  updateRegisterI2C(altitudeAddress, 0xF4, 0x2E);
}
  
unsigned int BarometricSensorBMP085::readRawTemperature(void) 
{
  sendByteI2C(altitudeAddress, 0xF6);
...
// ***********************************************************
void BarometricSensorBMP085::initialize(void) 
{
...
void BarometricSensorBMP085::measure(void) 
{
  ...
  previousPressureTime = pressureTime;
}
