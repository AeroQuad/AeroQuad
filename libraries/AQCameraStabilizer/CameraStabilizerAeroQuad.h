...
#ifndef _CAMERA_STABILIZER_AEROQUAD_H_
#define _CAMERA_STABILIZER_AEROQUAD_H_

#include <CameraStabilizer.h>

class CameraStabilizerAeroQuad : public CameraStabilizer {
public:
  CameraStabilizerAeroQuad() : CameraStabilizer() {}
