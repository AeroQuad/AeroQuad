...
void AccelADXL335::initialize(void) 
{
  // rollChannel = 1
  // pitchChannel = 0
  // zAxisChannel = 2
...
void AccelADXL335::measure(void) 
{
...
const int AccelADXL335::getFlightData(byte axis) 
{
  return getRaw(axis);
}
  
// Allows user to zero accelerometers on command
void AccelADXL335::calibrate(void) 
{
...
void AccelADXL335::calculateAltitude(void) 
{
  currentAccelTime = micros();
