...
FlightAngleKalmanFilter::FlightAngleKalmanFilter(Gyroscope *gyro,Accelerometer *accel) : FlightAngleProcessor(gyro,accel) 
{
...
float FlightAngleKalmanFilter::_calculate(byte axis, float newAngle, float newRate, unsigned long G_Dt) 
{
...
void FlightAngleKalmanFilter::initialize() 
{
  Q_angle = 0.001;
  Q_gyro = 0.003;
  R_angle = 0.03;
...
void FlightAngleKalmanFilter::calculate(unsigned long G_Dt) 
{
