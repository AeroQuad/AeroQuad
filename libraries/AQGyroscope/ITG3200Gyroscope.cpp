...
ITG3200Gyroscope::ITG3200Gyroscope()
{
  _gyroAddress = 0x69;
...
void ITG3200Gyroscope::initialize() 
{
...
const int ITG3200Gyroscope::getFlightData(byte axis) 
{
...
void ITG3200Gyroscope::calibrate() 
{
  autoZero();
}
  
void ITG3200Gyroscope::autoZero() 
{
