...
void GyroMultipilot::initialize(void) 
{
...
void GyroMultipilot::measure(void) 
{
  currentTime = micros();
...
const int GyroMultipilot::getFlightData(byte axis) 
{
  return getRaw(axis);
}

void GyroMultipilot::calibrate() 
{
  autoZero();
