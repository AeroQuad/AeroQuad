...
public: 
  ...
  void initialize(void) {
    ...
    _gyro->setStartHeading(gyroStartHeading);
  }
  ...
  void measure(void) {
    ...
    if (gyroZero != _gyro->getZero(YAW)) {
      _gyro->setStartHeading(heading);
      gyroZero = _gyro->getZero(YAW);
    }
    
    adjustedGyroHeading = _gyro->getHeading();
