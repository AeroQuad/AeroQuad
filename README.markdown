...
----------------------------------------
  ...
  * Fixed correct scaling for Kd for all flight modes (thanks to Ziojos & Honk).  Makes it easier to find the right PID gains ro remove oscillations during flight.  PID Tuning Guide is updated with best values to use.
