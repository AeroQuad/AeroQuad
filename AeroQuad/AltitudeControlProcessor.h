...
void computeEstimatedAltitude(float currentAltitude) {

  float altitudeError = currentAltitude - estimatedAltitude;
  ...
  float altitudeDelta = (zVelocity * G_Dt) * altitudeError;
...
void processAltitudeHold()
{
  ...
  // http://aeroquad.com/showthread.php?359-Stable-flight-logic...&p=10325&viewfull=1#post10325
    ...
    if (altitudeHoldState == ON) {
      ...
      int altitudeHoldThrottleCorrection = updatePID(altitudeToHoldTarget, estimatedAltitude, &PID[ALTITUDE_HOLD_PID_IDX]);
