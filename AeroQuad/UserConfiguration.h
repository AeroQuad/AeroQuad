...
//	#define POWERED_BY_VIN          	// NEED BattMonitor defined. Uncomment this if your v2.x shield is powered directly by the//in/Gnd of the arduino
//
...
//	#define BattCustomConfig DEFINE_BATTERY(0,A4,51.8,0,A3,180.3,0)
	#define BattCustomConfig DEFINE_BATTERY(0, BATT_ANALOG_INPUT, 15.4, 0, BM_NOPIN, 0, 0)
...
//	#define CALLSIGN "KF7YRK"         	// Show (optional) callsign
	...
	#define ShowCompass			    	// Enable compass heading indicator
