...
#ifndef _AEROQUAD_GYROSCOPE_L3GD20_H_
#define _AEROQUAD_GYROSCOPE_L3GD20_H_
...
void initializeGyro() {
  ...
  //updateRegisterI2C(GYRO_ADDRESS, GYRO_CTRL_REG1, 0b11111111); //output 760hz, 100hz cutoff
  delay(5);
  // If you'd like to adjust/use the High-pass filter, you can edit the line below to configure CTRL_REG2:
  ...
  if(GYRO_RATE == 250){
    ...
    updateRegisterI2C(GYRO_ADDRESS, GYRO_CTRL_REG4, 0b10110000); //2000dps
...
void readGyroRaw(int *gyroRaw) {
    sendByteI2C(GYRO_ADDRESS, 0x28 | (1 << 7)); // set MSB. Autoincrement from 0x28 register
