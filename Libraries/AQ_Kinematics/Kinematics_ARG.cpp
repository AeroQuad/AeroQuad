...
void Kinematics_ARG::argUpdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, unsigned long G_Dt) {
  float norm;
...
/*void Kinematics_ARG::eulerAngles(void) {
...
void Kinematics_ARG::initialize(float hdgX, float hdgY) 
{
  q0 = 1.0;
  q1 = 0.0;
  q2 = 0.0;
...
void Kinematics_ARG::calculate(float rollRate,          float pitchRate,    float yawRate,  \
...
float Kinematics_ARG::getGyroUnbias(byte axis) {
