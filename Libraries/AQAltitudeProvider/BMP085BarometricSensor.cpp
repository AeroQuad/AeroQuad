...
BMP085BarometricSensor::BMP085BarometricSensor()
{
...
void BMP085BarometricSensor::requestRawPressure() 
{
  updateRegisterI2C(_altitudeAddress, 0xF4, 0x34+(_overSamplingSetting<<6));
}
  
long BMP085BarometricSensor::readRawPressure() 
{
...
void BMP085BarometricSensor::requestRawTemperature() 
{
  updateRegisterI2C(_altitudeAddress, 0xF4, 0x2E);
}
  
unsigned int BMP085BarometricSensor::readRawTemperature() 
{
  sendByteI2C(_altitudeAddress, 0xF6);
...
// ***********************************************************
void BMP085BarometricSensor::initialize() 
{
...
void BMP085BarometricSensor::measure() 
{
  long x1;
  long x2;
  long x3;
