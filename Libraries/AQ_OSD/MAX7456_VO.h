...
#define VO_DISPLAY_RECT_HEIGHT 9 						// height of rectangle bounding AI. Should be odd so that
										// there is an equal space above/below the centre reticle
#define VO_MAX_PITCH_ANGLE (PI/8)						// bounds of scale used for displaying variometer. When variometer
										// is >= |this number|, the variometer lines will be at top or bottom
										// of bounding box
