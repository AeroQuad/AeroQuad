...
FlightAngleCompFilter::FlightAngleCompFilter()
{
  _filterTerm0[ROLL] = 0;
  _filterTerm1[ROLL] = 0;
...
void FlightAngleCompFilter::initialize(void) 
{
...
void FlightAngleCompFilter::calculate(float G_Dt) 
{
...
float FlightAngleCompFilter::getGyroUnbias(byte axis) 
{
...
float FlightAngleCompFilter::_calculate(byte axis, float newAngle, float newRate, float G_Dt) 
{
